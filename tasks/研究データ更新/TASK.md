...
| ファイル | 用途 |
|---------|------|
| `研究データ一覧_v4.csv` | v4の全140項目（カテゴリ、分野、No、項目名、効果値、効果値最大、現在Lv、最大レベル、M/専攻、備考、備考2） |
| `all_research_effects.json` | 全140項目のeffectsマッピング（既存85項目は現data-research.jsから引継、新規55項目は備考から生成） |
...
| `effects` | `all_research_effects.json` から取得 |
